...
void FadeQuad::Init()
{
	...
	// シェーダ
	Renderer::CreateVertexShader(&m_VertexShader, &m_VertexLayout, "shader\\CSOFile\\UnlitTextureVS.cso");
	Renderer::CreatePixelShader(&m_PixelShader, "shader\\CSOFile\\UnlitTexturePS.cso");

	// 白1×1テクスチャを読み込む
	m_TexWhite = Texture::Load("Asset\\Texture\\white.png");
}
