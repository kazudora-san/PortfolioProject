...
void MeshField::Init()
{
	// 頂点バッファ生成
	{
		for (int x = 0; x <= 20; x++)
		{
			...
			{
				float y = 0.0f;
				m_Vertex[x][z].Position = XMFLOAT3((x - 10) * 5.0f, g_FieldHight[x][z], (z - 10) * -5.0f);
	...
	m_Texture = Texture::Load("asset\\texture\\field_game.jpg");
	m_TextureSoil = Texture::Load("asset\\texture\\field.jpg");
